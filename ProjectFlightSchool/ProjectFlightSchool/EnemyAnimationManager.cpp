...
HRESULT EnemyAnimationManager::Initialize()
{
	...
	// Load Boomer Model
	// Load skeleton
	Graphics::GetInstance()->LoadSkeletonAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/Animations/", "firesquadSkel.Skel", skeleton );
	// Load animated 3d asset
	Graphics::GetInstance()->LoadAnimated3dAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/", "firesquad.apfs", skeleton, mModelBoomer );
	...
	Graphics::GetInstance()->LoadAnimationAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/Animations/", "firesquadIdle1.PaMan",			mAnimations[ENEMY_ANIMATION_BOOMER_IDLE] );
	Graphics::GetInstance()->LoadAnimationAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/Animations/", "firesquadWalk.PaMan",				mAnimations[ENEMY_ANIMATION_BOOMER_RUN] );
	Graphics::GetInstance()->LoadAnimationAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/Animations/", "firesquadHitandWalk.PaMan",		mAnimations[ENEMY_ANIMATION_BOOMER_RUN_DAMAGED] );
	Graphics::GetInstance()->LoadAnimationAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/Animations/", "firesquadAttack.PaMan",			mAnimations[ENEMY_ANIMATION_BOOMER_ATTACK] );
	Graphics::GetInstance()->LoadAnimationAsset( "../Content/Assets/ForestAssets/Enemies/Firesquad/Animations/", "firesquadDeath.PaMan",			mAnimations[ENEMY_ANIMATION_BOOMER_DEATH] );
