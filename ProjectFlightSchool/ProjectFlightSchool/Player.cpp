...
void Player::FireMinigun( XMFLOAT3* projectileOffset )
{
	...
	{
		float directionOffsetX	=  (float)( rand() % 100 - 50 ) * 0.01f - mLoadOut->rangedWeapon->spread;
		float directionOffsetZ	=  (float)( rand() % 100 - 50 ) * 0.01f - mLoadOut->rangedWeapon->spread;
