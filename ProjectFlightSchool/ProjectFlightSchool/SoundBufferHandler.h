...
protected:
public:
	int							Load3DBuffer( char* fileName, LONG volume = 0, int nrOfBuffers = 1 ); //highest is 0, lowest is 10 000. Since it's decibels 5 000 is not half the sound.
	int							LoadBuffer( char* fileName, LONG volume = 0, int nrOfBuffers = 1 ); //highest is 0, lowest is 10 000. Since it's decibels 5 000 is not half the sound.
	int							LoadStreamBuffer( char* fileName, LONG volume = 0, int nrOfBuffers = 1 ); //highest is 0, lowest is 10 000. Since it's decibels 5 000 is not half the sound.
